...
from trader.utility import extract_vt_symbol
from trader.object import HistoryRequest
from trader.datafeed import BaseDatafeed, get_datafeed
from trader.database import BaseDatabase, get_database

from app import cta_strategy
from app.cta_strategy import CtaTemplate
...
class BacktesterEngine(BaseEngine):
    ...
    def load_strategy_class(self):
        ...
        """
        app_path = Path(cta_strategy.__file__).parent
